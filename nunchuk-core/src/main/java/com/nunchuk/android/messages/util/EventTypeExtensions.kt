...
const val WALLET_REPLACEMENT_TIMELOCK_SET = "io.nunchuk.custom.wallet_replacement_timelock_set"
...
fun TimelineEvent.isReplaceKeyChangeEvent() =
    getMsgType() == KEY_REPLACED || getMsgType() == KEY_RESET || getMsgType() == WALLET_KEY_REPLACEMENT_REMOVE || getMsgType() == WALLET_REPLACEMENT_TIMELOCK_SET
