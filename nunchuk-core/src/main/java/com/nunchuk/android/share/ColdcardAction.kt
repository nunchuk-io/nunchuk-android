...
enum class ColdcardAction {
    CREATE, RECOVER_KEY, RECOVER_MULTI_SIG_WALLET, RECOVER_SINGLE_SIG_WALLET, PARSE_MULTISIG_WALLET, PARSE_SINGLE_SIG_WALLET, INHERITANCE_PASSPHRASE_QUESTION, VERIFY_KEY
}
