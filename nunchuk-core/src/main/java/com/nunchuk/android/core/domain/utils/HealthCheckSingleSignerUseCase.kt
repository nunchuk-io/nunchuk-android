...
class HealthCheckSingleSignerUseCase @Inject constructor(
    @IoDispatcher private val dispatcher: CoroutineDispatcher,
    private val nunchukNativeSdk: NunchukNativeSdk
) : UseCase<HealthCheckSingleSignerUseCase.Param, HealthStatus>(dispatcher) {

    override suspend fun execute(parameters: Param): HealthStatus {
        return nunchukNativeSdk.healthCheckSingleSigner(
