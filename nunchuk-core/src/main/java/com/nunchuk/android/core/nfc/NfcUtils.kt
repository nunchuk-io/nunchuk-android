...
import com.nunchuk.android.core.nfc.BaseNfcActivity.Companion.REQUEST_IMPORT_WALLET_FROM_MK4
...
fun shouldShowInputCvcFirst(requestCode: Int) = requestCode != REQUEST_NFC_STATUS
        ...
        && requestCode != REQUEST_IMPORT_WALLET_FROM_MK4
...
fun getMk4Hint(context: Context, requestCode: Int) = when (requestCode) {
    ...
    REQUEST_IMPORT_WALLET_FROM_MK4 -> context.getString(R.string.nc_hint_import_wallet_from_mk4)
    else -> ""
}