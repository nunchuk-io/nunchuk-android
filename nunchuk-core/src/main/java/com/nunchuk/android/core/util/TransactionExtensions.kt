...
fun TransactionStatus.signDone() = canBroadCast() || isPendingConfirm() || isConfirmed()

fun TransactionStatus.isPendingSignatures() = this == PENDING_SIGNATURES || this == PENDING_NONCE
