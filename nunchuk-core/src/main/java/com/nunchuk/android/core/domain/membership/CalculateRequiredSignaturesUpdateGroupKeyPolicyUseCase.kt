...
class CalculateRequiredSignaturesUpdateGroupKeyPolicyUseCase @Inject constructor(
    @IoDispatcher dispatcher: CoroutineDispatcher,
    private val userWalletsRepository: PremiumWalletRepository,
) : UseCase<CalculateRequiredSignaturesUpdateGroupKeyPolicyUseCase.Param, CalculateRequiredSignatures>(
    dispatcher
) {
