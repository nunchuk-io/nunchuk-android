...
data class WalletDto(
    ...
    @SerializedName("signers") val signerServerDtos: List<SignerServerDto>? = null,
    ...
    @SerializedName("requires_registration") val requiresRegistration: Boolean? = null,
...
internal fun WalletDto.toModel(): WalletServer {
    return WalletServer(
        ...
        signers = signerServerDtos?.map { it.toModel() } ?: emptyList(),
        status = status ?: "",
