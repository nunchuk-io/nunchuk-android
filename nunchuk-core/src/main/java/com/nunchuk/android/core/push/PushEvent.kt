...
sealed class PushEvent {
    ...
    data object DismissCurrentAlert : PushEvent()
    ...
    data class InheritanceEvent(val walletId: String, val isCancelled: Boolean) : PushEvent()
    ...
    data class ClaimSignerAdded(val signer: SingleSigner) : PushEvent()
