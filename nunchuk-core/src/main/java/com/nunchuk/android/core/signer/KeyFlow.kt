...
object KeyFlow {
    ...
    fun Int.isPrimaryKeyFlow() =
        this != NONE && this != REPLACE_KEY_IN_FREE_WALLET && this != ADD_AND_RETURN_PASSPHRASE && this != ADD_AND_RETURN && this != ADD_AND_PUSH
    ...
    fun Int.isAddAndPushFlow() = this == ADD_AND_PUSH
}