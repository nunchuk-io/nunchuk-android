...
private fun TapSignerListContent(
    ...
    Column(
        ...
        if (signerLabel.isNotEmpty() || description.isNotEmpty()) {
            Text(
                ...
                text = description.ifEmpty {
                    stringResource(R.string.nc_notice_you_have_exist_key, signerLabel)
                },
        ...
        NcPrimaryDarkButton(
            ...
            Text(text = stringResource(R.string.nc_add_existing_key))
        }
        NcOutlineButton(
            modifier = Modifier
                .fillMaxWidth()
            ...
            Text(text = stringResource(R.string.nc_take_me_to_add_new_key))
        }
    }
}
...
@Preview
@Composable
private fun TapSignerListContentPreview(
