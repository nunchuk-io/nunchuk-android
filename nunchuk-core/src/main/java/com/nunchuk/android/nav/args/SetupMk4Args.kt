...
data class SetupMk4Args(
    ...
    companion object {
        private const val FROM_MEMBERSHIP_FLOW = "is_membership_flow"
        private const val ACTION = "action"
        private const val GROUP_ID = "group_id"
        private const val NEW_INDEX = "index"
        private const val IS_SCAN_QR_CODE = "scan_qr_code"
        private const val REPLACED_XFP = "replace_xfp"
        private const val WALLET_ID = "wallet_id"
        private const val SIGNER_TYPE = "signer_type"
        private const val BACKUP_FILE_PATH = "back_up_file_path"
        private const val KEY_ID = "key_id"
        private const val KEY_NAME = "key_name"
        private const val XFP = "xfp"
        private const val BACKUP_FILE_NAME = "back_up_file_name"
