...
class SignInDummyTransactionIntroFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return ComposeView(requireContext()).apply {
            val args: SignInAuthenticationActivityArgs by requireActivity().navArgs()
                ...
                DummyTransactionIntroContent(
                    ...
                    onContinueClicked = {
                        findNavController().navigate(
                            SignInDummyTransactionIntroFragmentDirections.actionSignInDummyTransactionIntroFragmentToSignInDummyTransactionDetailsFragment()
                        )
                    },
                    onCancelClicked = {
