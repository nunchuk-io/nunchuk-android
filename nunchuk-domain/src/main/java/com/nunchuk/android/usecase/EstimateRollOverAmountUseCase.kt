...
class EstimateRollOverAmountUseCase @Inject constructor(
    @IoDispatcher ioDispatcher: CoroutineDispatcher,
    private val nativeSdk: NunchukNativeSdk,
) : UseCase<EstimateRollOverAmountUseCase.Param, PairAmount>(ioDispatcher) {

    override suspend fun execute(parameters: Param): PairAmount {
        return nativeSdk.estimateRollOverAmount(
