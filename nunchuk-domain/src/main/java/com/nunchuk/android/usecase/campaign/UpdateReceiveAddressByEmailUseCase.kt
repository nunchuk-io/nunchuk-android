...
class UpdateReceiveAddressByEmailUseCase @Inject constructor(
    private val repository: CampaignsRepository,
    @IoDispatcher ioDispatcher: CoroutineDispatcher
) : UseCase<UpdateReceiveAddressByEmailUseCase.Params, ReferrerCode?>(ioDispatcher) {
    override suspend fun execute(parameters: Params): ReferrerCode? {
        return repository.updateReceiveAddressByEmail(
    ...
    data class Params(val receiveAddress: String, val email: String, val token: String, val walletId: String)
}