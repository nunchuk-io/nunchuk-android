...
class DeleteGroupDummyTransactionUseCase @Inject constructor(
    @IoDispatcher private val ioDispatcher: CoroutineDispatcher,
    private val dummyTransactionRepository: DummyTransactionRepository,
) : UseCase<DeleteGroupDummyTransactionUseCase.Param, Unit>(ioDispatcher) {

    override suspend fun execute(parameters: Param): Unit =
        dummyTransactionRepository.deleteDummyTransaction(
