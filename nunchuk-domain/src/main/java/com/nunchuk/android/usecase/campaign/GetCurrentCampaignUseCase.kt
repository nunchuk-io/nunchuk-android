...
class GetCurrentCampaignUseCase @Inject constructor(
    private val repository: CampaignsRepository,
    @IoDispatcher ioDispatcher: CoroutineDispatcher
) : UseCase<GetCurrentCampaignUseCase.Param, Campaign?>(ioDispatcher) {
    override suspend fun execute(parameters: Param): Campaign? {
        return repository.getCurrentCampaigns(parameters.email)
    }
