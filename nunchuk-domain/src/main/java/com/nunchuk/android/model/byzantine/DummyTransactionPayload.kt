...
enum class DummyTransactionType : Parcelable {
    NONE, DOWNLOAD_KEY_BACKUP, UPDATE_SECURITY_QUESTIONS, CREATE_INHERITANCE_PLAN, UPDATE_INHERITANCE_PLAN, CANCEL_INHERITANCE_PLAN, UPDATE_SERVER_KEY, HEALTH_CHECK_REQUEST, HEALTH_CHECK_PENDING, REQUEST_INHERITANCE_PLANNING, KEY_RECOVERY_REQUEST
}
