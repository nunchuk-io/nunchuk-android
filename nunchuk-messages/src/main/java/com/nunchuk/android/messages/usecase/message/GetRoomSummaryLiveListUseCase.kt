...
interface GetRoomSummaryLiveListUseCase {
    fun execute(): Flow<List<RoomSummary>>
}

internal class GetRoomSummaryLiveListUseCaseImpl @Inject constructor(
    private val leaveRoomUseCase: LeaveRoomUseCase
) : BaseMessageUseCase(), GetRoomSummaryLiveListUseCase {
