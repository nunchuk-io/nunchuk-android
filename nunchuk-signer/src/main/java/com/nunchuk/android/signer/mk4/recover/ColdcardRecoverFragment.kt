            ...
            Column(
                ...
                LabelNumberAndDesc(
                    ...
                    val exportInstruction = when {
                        onChainAddSignerParam != null -> if (isScanQRCode) {
                            stringResource(
                                R.string.nc_export_xpub_coldcard_onchain_scan_qr_code_desc,
                                onChainKeyIndex
                            )
                        } else  {
                            stringResource(
                                R.string.nc_export_xpub_coldcard_onchain_file_desc,
                                onChainKeyIndex
                            )
                        }
