...
sealed class ReviewWalletEvent {
    ...
    data class CreateWalletSuccessEvent(val wallet: Wallet) : ReviewWalletEvent()
    data class CreateFreeGroupWalletSuccessEvent(val walletId: String) : ReviewWalletEvent()
