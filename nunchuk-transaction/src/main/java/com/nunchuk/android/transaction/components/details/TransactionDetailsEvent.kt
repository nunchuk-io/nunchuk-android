...
sealed class TransactionDetailsEvent {
    ...
    data class PromptTransactionOptions(val isPendingTransaction: Boolean, val isPendingConfirm: Boolean, val masterFingerPrint: String = "") : TransactionDetailsEvent()
